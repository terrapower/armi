...
class TestBlockCollectionComponentAverage1DCylinder(unittest.TestCase):
    ...
    def setUp(self):
        ...
        steelDensity = {
            "C": 0.0007685387802776058,
            "V": 0.00027181268172609937,
            "SI28": 0.0003789237709446422,
            "SI29": 1.9239943203013444e-05,
            "SI30": 1.2682832514990922e-05,
            "CR50": 0.000453186029919893,
            "CR52": 0.008739241591287444,
            "CR53": 0.000990959832052682,
            "CR54": 0.0002466708770450051,
            "MN55": 0.0004200652171858018,
            "FE54": 0.00410134874664333,
            "FE56": 0.06438240285659785,
            "FE57": 0.001486870486593193,
            "FE58": 0.00019787516621957548,
            "NI58": 0.00029443814676257475,
            "NI60": 0.0001134164428853456,
            "NI61": 4.930585550444034e-06,
            "NI62": 1.5717322710801423e-05,
            "NI64": 4.005019490974717e-06,
            "MO92": 7.139922972279386e-05,
            "MO94": 4.450423685551505e-05,
            "MO95": 7.659540007997834e-05,
            "MO96": 8.025196440540443e-05,
            "MO97": 4.5947617510288514e-05,
            "MO98": 0.00011609591252100986,
            "MO100": 4.63325190182281e-05,
            "W182": 3.663487245360046e-05,
            "W183": 1.9782831124944246e-05,
            "W184": 4.2358205862016815e-05,
            "W186": 3.930299712663626e-05,
        }
        linerAdjustment = 1.01427718589186
        cladDensity = {
        ...
        for c, compDensity, compArea in zip(
            ...
            for nuc in cNucs:
                self.assertAlmostEqual(
                    c.getNumberDensity(nuc), compDensity.get(nuc, 0.0), msg=f"{c}"
                )
