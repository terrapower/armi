...
class MacroscopicCrossSectionCreator:
    ...
    def __init__(self, buildScatterMatrix=True, buildOnlyCoolant=False, minimumNuclideDensity=0.0):
        self.densities = None
        self.macros = None
        self.micros = None
        self.minimumNuclideDensity = minimumNuclideDensity
        self.buildScatterMatrix = buildScatterMatrix
        self.buildOnlyCoolant = buildOnlyCoolant  # TODO: this is not implemented yet. is it needed?
        self.block = None
