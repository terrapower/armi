...
# LOWEST_ENERGY_EV cannot be zero due to integrating lethargy, and lethargy blows up at 0.0
...
# defined group structures, and as of this writing the lowest is cinder63 with a lowest
# upper boundary of 5e-3 eV. The chosen 1e-5 eV is rather arbitrary but expected to be low
