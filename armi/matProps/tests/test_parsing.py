...
class TestParsing(unittest.TestCase):
    ...
    def test_loadMaterialsFromFiles(self):
        """Test loading materials from local data files.

        .. test:: Material objects can be generated by loading custom-formatted YAML files.
            :id: T_ARMI_MAT_YAML0
            :tests: R_ARMI_MAT_YAML
        """
    ...
    def test_multiDataLoadingMultidir(self):
        ...
        .. test:: Material objects can be generated by loading directories of custom YAML files.
            :id: T_ARMI_MAT_YAML1
            :tests: R_ARMI_MAT_YAML
        """
