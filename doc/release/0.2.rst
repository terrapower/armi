...
#. Overhaul of the tight coupling routine in ARMI, and removal of ``looseCoupling`` setting. (`https://github.com/terrapower/armi/pull/1033`_)
#. Added ``savePhysicsFiles`` setting to copy physics kernel I/O to directories organized by cycle and time step (e.g., c2n1). (`PR#958 <https://github.com/terrapower/armi/pull/952>`_)
