...
#. Copy physics kernel inputs and outputs to directories organized by cycle and time step number (e.g., c2n1) to retain all important files from a simulation and avoid overwriting them.
