...
Bug fixes
---------
#. Supporting swapping assemblies with different block meshes in ``_swapFluxParam``.
...
#. Fixed issue in ``armi/reactor/blocks.py::HexBlock::rotatePins`` that failed to modify pinLocation parameter (`#855 <https://github.com/terrapower/armi/pull/855>`_).
#. TBD
