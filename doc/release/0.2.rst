...
#  Revert "when using non-uniform mesh, detailed fission/activation products have cross sections generated to avoid blocks without xs data" and move capability to lattice physics (`PR#1298 <https://github.com/terrapower/armi/pull/1298>`_)
