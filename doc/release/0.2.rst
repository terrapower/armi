...
#. Addition of new methods to compute and update the grid plate pitch for a given isothermal temperature. (`PR#993 https://github.com/terrapower/armi/pull/993`)
