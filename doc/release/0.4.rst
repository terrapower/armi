...
#. Removing setting ``mpiTasksPerNode`` (`PR#1953 <https://github.com/terrapower/armi/pull/1953>`)
#. Renaming ``numProcessors`` to ``nTasks`` (`PR#1958 <https://github.com/terrapower/armi/pull/1958>`)
#. TBD
