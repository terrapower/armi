...
#. Add a method getPinMgFluxes to retrieve the pin-wise multigroup fluxes from a Block. (`PR#1990 <https://github.com/terrapower/armi/pull/1990>`_)
...
#. Removing ``Blocks.py::block::breakFuelComponentsIntoIndividuals``. (`PR#1990 <https://github.com/terrapower/armi/pull/1990>`_)
#. Move getPuMoles from blocks.py up to composites.py. (`PR#1990 <https://github.com/terrapower/armi/pull/1990>`_)
#. TBD
