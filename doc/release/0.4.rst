...
#. Renaming ``numProcessors`` to ``nTasks``. (`PR#1958 <https://github.com/terrapower/armi/pull/1958>`_)
#. Renaming ``mpiTasksPerNode`` to ``nTasksPerNode``. (`PR#1964 <https://github.com/terrapower/armi/pull/1964>`_)
>>>>>>> main
#. TBD
