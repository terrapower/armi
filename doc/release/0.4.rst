...
#. Provide utilities for determining location of a rotated object in a hexagonal lattice. (`PR#1846 <https://github.com/terrapower/armi/1846`_)
...
#. ``Assembly.rotatePins`` and ``Block.rotatePins`` have been removed. Prefer ``Assembly.rotate`` and ``Block.rotate``. (`PR#1846 <https://github.com/terrapower/armi/1846`_)
#. TBD
