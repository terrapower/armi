...
===============================================
ARMI is used by TerraPower, LLC and other organizations to perform nuclear reactor simulation and analyses. Because of this, ARMI maintains a strong quality program that requires a human to be held responsible for all changes to the codebase. Additionally, ARMI's Contributor License Agreement (CLA) requires that `work submitted is your own <https://github.com/terrapower/armi/blob/6b5208e8ef95620fb0ce993e000043f3147faabe/CONTRIBUTING.md?plain=1#L23>`_, and you `hold the copyright to any work submitted <https://github.com/terrapower/armi/blob/6b5208e8ef95620fb0ce993e000043f3147faabe/CONTRIBUTING.md?plain=1#L45>`_. Because an LLM cannot be held responsible or accountable for quality or saftey, cannot be considered original work, and cannot hold copyright, ARMI contributions must adhere to the following requirements:

1. All code, comments, and associated documentation generated by an LLM must be reviewed and edited for conciseness and correctness by a human before submitting a GitHub PR or Issue.
2. Tests for code generated by an LLM shall be written by a human.
3. Fully agentic PRs or Issues will not be accepted. (To that end, PR and Issue titles and descriptions shall be written by a human.)

PRs and Issues that violate the above rules may be summarily closed.
